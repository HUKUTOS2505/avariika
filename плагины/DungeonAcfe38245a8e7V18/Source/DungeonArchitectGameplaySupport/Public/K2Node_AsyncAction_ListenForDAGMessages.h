...
#include "K2Node_AsyncAction_ListenForDAGMessages.generated.h"
...
/**
 * Blueprint node which is spawned to handle the async logic for UAsyncAction_ListenForDAGMessages
 */

UCLASS()
class UK2Node_AsyncAction_ListenForDAGMessages : public UK2Node_AsyncAction
{
	GENERATED_BODY()
