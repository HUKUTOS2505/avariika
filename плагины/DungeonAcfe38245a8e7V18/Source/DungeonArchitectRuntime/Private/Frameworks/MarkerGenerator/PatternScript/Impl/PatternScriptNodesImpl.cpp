...
/////////////////////// Node: CopyMarkers ///////////////////////
const FName UMGPatternScriptNode_CopyMarkers::InPinID_Default = "DefaultInput";
const FName UMGPatternScriptNode_CopyMarkers::OutPinID_Default = "DefaultOutput";
void UMGPatternScriptNode_CopyMarkers::AllocateDefaultPins() {
	AddInputPin<UMGPatternScriptNodePinExec>(InPinID_Default, true);
	AddOutputPin<UMGPatternScriptNodePinExec>(OutPinID_Default);
}

FText UMGPatternScriptNode_CopyMarkers::GetNodeTitle() const {
	static const FText NodeTitle = LOCTEXT("NodeTitle_CopyMarkers", "Copy Markers");
	return NodeTitle;
}
...
/////////////////////// Node: RenameMarkers ///////////////////////
const FName UMGPatternScriptNode_RenameMarkers::InPinID_Default = "DefaultInput";
const FName UMGPatternScriptNode_RenameMarkers::OutPinID_Default = "DefaultOutput";
void UMGPatternScriptNode_RenameMarkers::AllocateDefaultPins() {
	AddInputPin<UMGPatternScriptNodePinExec>(InPinID_Default, true);
	AddOutputPin<UMGPatternScriptNodePinExec>(OutPinID_Default);
}

FText UMGPatternScriptNode_RenameMarkers::GetNodeTitle() const {
	static const FText NodeTitle = LOCTEXT("NodeTitle_RenameMarkers", "Rename Markers");
	return NodeTitle;
}
