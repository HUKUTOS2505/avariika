...
UTextureRenderTarget2D* FFlowTilemapRenderer::Create(UFlowTilemap* Tilemap, const FFlowTilemapRendererSettings& Settings) {
    ...
    if (!OneWayTileTexL) OneWayTileTexL = Cast<UTexture2D>(StaticLoadObject(
        UTexture2D::StaticClass(), nullptr, TEXT("/DungeonArchitect/Core/Runtime/Assets/Textures/GridFlow/Tilemap/onewaydoor_left")));
    if (!OneWayTileTexR) OneWayTileTexR = Cast<UTexture2D>(StaticLoadObject(
        UTexture2D::StaticClass(), nullptr, TEXT("/DungeonArchitect/Core/Runtime/Assets/Textures/GridFlow/Tilemap/onewaydoor_right")));
    if (!OneWayTileTexU) OneWayTileTexU = Cast<UTexture2D>(StaticLoadObject(
        UTexture2D::StaticClass(), nullptr, TEXT("/DungeonArchitect/Core/Runtime/Assets/Textures/GridFlow/Tilemap/onewaydoor_up")));
    if (!OneWayTileTexD) OneWayTileTexD = Cast<UTexture2D>(StaticLoadObject(
        UTexture2D::StaticClass(), nullptr, TEXT("/DungeonArchitect/Core/Runtime/Assets/Textures/GridFlow/Tilemap/onewaydoor_down")));
