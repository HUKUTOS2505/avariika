...
public:
    ...
    UPROPERTY(EditAnywhere, Category = "Dungeon")
    TObjectPtr<UTexture2D> PreviewSprite = nullptr;;
...
public:
    ...
    TObjectPtr<UPlaceableMarkerAsset> MarkerAsset = nullptr;;
...
public:
    ...
    TObjectPtr<UPlaceableMarkerComponent> PlaceableMarkerComponent;
