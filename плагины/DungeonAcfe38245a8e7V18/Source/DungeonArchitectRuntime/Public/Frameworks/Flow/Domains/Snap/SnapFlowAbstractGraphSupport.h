...
public:
    ...
    virtual bool IsValid(const FFlowAbstractGraphQuery& InGraphQuery, const UFlowAbstractNode* Node, const TArray<const UFlowAbstractNode*>& InIncomingNodes, const TArray<const UFlowAbstractNode*>& InOutgoingNodes) override;
...
class DUNGEONARCHITECTRUNTIME_API USnapFlowNodeCategorySelectionOverride : public UObject {
    GENERATED_BODY()
public:
...
public:
    ...
    TArray<TObjectPtr<USnapFlowNodeCategorySelectionOverride>> CategoryOverrideLogic;
};
