...
enum class EDungeonLevelStreamChunkSelection : uint8
{
    ...
    AlwaysResidentLocations   UMETA(DisplayName = "Always Resident Locations"),
};
...
struct DUNGEONARCHITECTRUNTIME_API FDungeonLevelStreamingConfig {
     ...
     * AlwaysResident - The chunks tagged as always-resident (e.g. spawn rooms) get streamed in first
     */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Dungeon Streaming", Meta=(EditCondition = "bEnabledLevelStreaming"))
    EDungeonLevelStreamChunkSelection InitialLoadLocation = EDungeonLevelStreamChunkSelection::AlwaysResidentLocations;
