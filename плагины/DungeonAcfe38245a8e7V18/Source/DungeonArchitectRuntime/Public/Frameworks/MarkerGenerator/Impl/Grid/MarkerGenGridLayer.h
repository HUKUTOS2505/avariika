...
public:
	 ...
	 */
	UPROPERTY(EditAnywhere, Category="Constraints", meta=(EditCondition="bEnabled"))
	TArray<FString> SameHeightMarkers;

	UPROPERTY(EditAnywhere, Category=Advanced, meta=(EditCondition="bEnabled"))
	bool bExpandMarkerDomain = false;
    	
	UPROPERTY(EditAnywhere, Category=Advanced, Meta=(EditCondition="bExpandMarkerDomain && bEnabled", UIMin = 0, UIMax = 10, ClampMin = 0, ClampMax = 20))
