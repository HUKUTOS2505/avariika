...
private:
	template<typename TGraphNodePin>
	TGraphNodePin* AddPinImpl(TMap<FName, TObjectPtr<UMGPatternScriptNodePin>>& InPinMap, EMGPatternScriptPinDirection InDirection,
...
public:
	...
	UPROPERTY()
	TMap<FName, TObjectPtr<UMGPatternScriptNodePin>> InputPins;

	UPROPERTY()
	TMap<FName, TObjectPtr<UMGPatternScriptNodePin>> OutputPins;
