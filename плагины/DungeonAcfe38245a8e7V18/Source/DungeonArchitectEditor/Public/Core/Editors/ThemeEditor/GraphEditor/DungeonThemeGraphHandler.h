...
public:
    ...
    void Bind();
    void Initialize(TSharedPtr<SGraphEditor> InGraphEditor, TWeakPtr<IDetailsView> InPropertyEditor, UEdGraph* InThemeGraph);
    ...
    void SetEditorPropertiesCallback(const TFunction<UObject*()>& InFuncGetEditorProperties) { FuncGetEditorProperties = InFuncGetEditorProperties; }
...
private:
    ...
    TFunction<UObject*()> FuncGetEditorProperties;
};
