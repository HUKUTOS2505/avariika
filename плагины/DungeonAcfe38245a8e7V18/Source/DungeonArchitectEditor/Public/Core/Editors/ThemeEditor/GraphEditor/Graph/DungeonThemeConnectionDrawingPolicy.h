...
class DUNGEONARCHITECTEDITOR_API FDungeonThemeConnectionDrawingPolicy : public FConnectionDrawingPolicy {
protected:
    UEdGraph* GraphObj;
...
public:
    //
    FDungeonThemeConnectionDrawingPolicy(int32 InBackLayerID, int32 InFrontLayerID, float ZoomFactor,
