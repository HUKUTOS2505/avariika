...
void FDungeonArchitectStyle::FStyle::Initialize() {
    ...
    // Generic styles
    {
        ...
        Set("DungeonArchitect.Icons.Error", new PLUGIN_IMAGE_BRUSH("Icons/Common/icon_error_40x", Icon40x40));
    }
    ...
    // Theme Editor
    {
        ...
        Set( "ThemeEd.Graph.ThemeNode.Index.BackgroundColor", FLinearColor(0.05f, 0.1f, 0.1f, 1.0f) );
        Set( "ThemeEd.Graph.ThemeNode.Index.BackgroundHoveredColor", FLinearColor(1.0f, 0.0f, 0.0f, 1.0f) );
        
        FTextBlockStyle GraphNodeTitle = FTextBlockStyle(NormalText)
            .SetFont(DEFAULT_FONT( "Bold", 8 ))
            .SetColorAndOpacity(FLinearColor(0, 0, 0, 0.5f))
        ;
        Set( "ThemeEd.Graph.ThemeNode.IndexText", GraphNodeTitle );
    }

    // Forge Editor
    {
        Set("Forge.Layer.Default", new PLUGIN_IMAGE_BRUSH("Icons/Editors/Forge/icon_forge_layer_default_16px", Icon16x16));
        Set("Forge.Layer.Doc", new PLUGIN_IMAGE_BRUSH("Icons/Editors/Forge/doc_16x", Icon16x16));
        Set("Forge.Layer.Folder", new PLUGIN_IMAGE_BRUSH("Icons/Editors/Forge/FolderClosed", Icon16x16));
        Set("Forge.Layer.Folder.Open", new PLUGIN_IMAGE_BRUSH("Icons/Editors/Forge/FolderOpen", Icon16x16));
        
        Set("Forge.Layer.Grid2D", new PLUGIN_IMAGE_BRUSH("Icons/Editors/Forge/icon_forge_layer_grid2d_16px", Icon16x16));
        Set("Forge.Layer.Grid3D", new PLUGIN_IMAGE_BRUSH("Icons/Editors/Forge/icon_forge_layer_grid3d_16px", Icon16x16));
        Set("Forge.Layer.Texture", new PLUGIN_IMAGE_BRUSH("Icons/Editors/Forge/icon_forge_layer_texture_16px", Icon16x16));
        Set("Forge.Layer.Root", new PLUGIN_IMAGE_BRUSH("Icons/Editors/Forge/icon_forge_layer_root_16px", Icon16x16));

        // Layer drop down
        Set("DungeonForgeEditorMode.CreateLayerGrid2D", new PLUGIN_IMAGE_BRUSH("Icons/Editors/Forge/icon_forge_layer_grid2d_16px", Icon16x16));
        Set("DungeonForgeEditorMode.CreateLayerGrid3D", new PLUGIN_IMAGE_BRUSH("Icons/Editors/Forge/icon_forge_layer_grid3d_16px", Icon16x16));
        Set("DungeonForgeEditorMode.CreateLayerTexture", new PLUGIN_IMAGE_BRUSH("Icons/Editors/Forge/icon_forge_layer_texture_16px", Icon16x16));
        Set("DungeonForgeEditorMode.CreateLayerFolder", new PLUGIN_IMAGE_BRUSH("Icons/Editors/Forge/FolderClosed", Icon16x16));

        // Forge Graph Editor
        Set("Forge.NodeOverlay.Debug", new CORE_IMAGE_BRUSH_SVG("Starship/Blueprints/Breakpoint_Valid", Icon20x20, FSlateColor(FColor::Cyan)));
    }
    ...
    // Canvas Editor
    {
        Set("DungeonCanvasEditor.Compile", new PLUGIN_IMAGE_BRUSH("Icons/Common/icon_compile_40x", Icon40x40));
        Set("DungeonCanvasEditor.EditCanvasSettings", new PLUGIN_IMAGE_BRUSH("Icons/Common/icon_game_settings_40x", Icon40x40));
        Set("DungeonCanvasEditor.EditDungeonSettings", new PLUGIN_IMAGE_BRUSH("Icons/Common/icon_game_settings_40x", Icon40x40));
        Set("DungeonCanvasEditor.RandomizeDungeon", new PLUGIN_IMAGE_BRUSH("Icons/Common/icon_randomize_40x", Icon40x40));
    }
    ...
    // Theme Editor Mode
    {
        Set( "ThemeEdMode.Tool.Title", FTextBlockStyle(NormalText)
            .SetFont( DEFAULT_FONT( "BoldCondensed", 16 ) )
            .SetColorAndOpacity( FLinearColor(1, 1, 1, 0.9f) )
            .SetShadowOffset( FVector2D::ZeroVector )
        );
    }
    ...
    // Rich text editor
    {
        ...
        Set("DA.RichText.Normal", TargetSettingsNormal);

        Set("DA.RichText.Strong", FTextBlockStyle(TargetSettingsNormal)
            .SetFont(DEFAULT_FONT("Bold", FCoreStyle::RegularTextSize))
            .SetShadowOffset(FVector2D::UnitVector));
        
        Set("DA.RichText.Strong.Highlight", FTextBlockStyle(TargetSettingsNormal)
            .SetFont(DEFAULT_FONT("Bold", FCoreStyle::RegularTextSize))
