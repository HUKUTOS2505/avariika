...
void FSnapMapExecGraphEditorHandler::PerformLayout() {
    FIntPoint ResultGraphSpacing = Settings.IsValid() ? Settings->ResultGraphSpacing : FIntPoint(150, 100);
    ResultGraph->LayoutGraph(ResultGraphSpacing.X, ResultGraphSpacing.Y);
}
