...
FDungeonEditorViewportClient::FDungeonEditorViewportClient(TWeakPtr<SThemePreviewViewport> InDungeonEditorViewport,
                                                           FPreviewScene& InPreviewScene, UDungeonThemeAsset* InProp)
    : FEditorViewportClient(nullptr, &InPreviewScene, InDungeonEditorViewport),
      InDungeonEditorViewport(InDungeonEditorViewport),
      InProp(InProp) {
