...
void SGraphNode_DungeonMarkerEmitter::Construct(const FArguments& InArgs, UEdGraphNode_DungeonThemeMarkerEmitter* InNode) {
    GraphNode = InNode;
...
void SGraphNode_DungeonMarkerEmitter::CreatePinWidgets() {
    UEdGraphNode_DungeonThemeMarkerEmitter* DungeonNode = CastChecked<UEdGraphNode_DungeonThemeMarkerEmitter>(GraphNode);
...
void SGraphNode_DungeonMarkerEmitter::OnPropertyChanged(UEdGraphNode_DungeonThemeBase* Sender, const FName& PropertyName) {
    UpdateGraphNode();
}
