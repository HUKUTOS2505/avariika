...
void SGraphPalette_PropActions::Construct(const FArguments& InArgs, const TWeakObjectPtr<UEdGraph>& InGraph) {
    this->GraphPtr = InGraph;
...
void SGraphPalette_PropActions::CollectAllActions(FGraphActionListBuilderBase& OutAllActions) {
    const UEdGraphSchema_DungeonTheme* Schema = GetDefault<UEdGraphSchema_DungeonTheme>();
