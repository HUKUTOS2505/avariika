...
/////////////////////// UMGPatternGraphNode_CopyMarkers ///////////////////////
UMGPatternGraphNode_CopyMarkers::UMGPatternGraphNode_CopyMarkers(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
	NodeTemplate = ObjectInitializer.CreateDefaultSubobject<UMGPatternScriptNode_CopyMarkers>(this, "Template");
}

void UMGPatternGraphNode_CopyMarkers::AllocateDefaultPins() {
...
/////////////////////// UMGPatternGraphNode_RenameMarkers ///////////////////////
UMGPatternGraphNode_RenameMarkers::UMGPatternGraphNode_RenameMarkers(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
	NodeTemplate = ObjectInitializer.CreateDefaultSubobject<UMGPatternScriptNode_RenameMarkers>(this, "Template");
}

void UMGPatternGraphNode_RenameMarkers::AllocateDefaultPins() {
	CreatePin(EGPD_Input, FMGPatternPinCategory::Exec, "");
	CreatePin(EGPD_Output, FMGPatternPinCategory::Exec, "");
}
