...
FDungeonThemeConnectionDrawingPolicy::FDungeonThemeConnectionDrawingPolicy(
...
void FDungeonThemeConnectionDrawingPolicy::DetermineWiringStyle(UEdGraphPin* OutputPin, UEdGraphPin* InputPin, /*inout*/
...
void FDungeonThemeConnectionDrawingPolicy::Draw(TMap<TSharedRef<SWidget>, FArrangedWidget>& InPinGeometries,
...
void FDungeonThemeConnectionDrawingPolicy::DrawPreviewConnector(const FGeometry& PinGeometry,
...
void FDungeonThemeConnectionDrawingPolicy::DrawSplineWithArrow(const FVector2D& StartAnchorPoint,
...
void FDungeonThemeConnectionDrawingPolicy::Internal_DrawLineWithArrow(const FVector2D& StartAnchorPoint,
                                                                     const FVector2D& EndAnchorPoint,
                                                                     const FConnectionParams& Params) {
...
void FDungeonThemeConnectionDrawingPolicy::DrawSplineWithArrow(const FGeometry& StartGeom, const FGeometry& EndGeom,
                                                              const FConnectionParams& Params) {
...
void FDungeonThemeConnectionDrawingPolicy::DrawConnection(int32 LayerId, const FVector2D& Start, const FVector2D& End,
                                                         const FConnectionParams& Params) {
