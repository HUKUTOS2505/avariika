...
#include UE_INLINE_GENERATED_CPP_BY_NAME(DAGTeamCheats)

//////////////////////////////////////////////////////////////////////
// UDAG_TeamCheats

void UDAG_TeamCheats::CycleTeam()
{
	if (UDAG_TeamSubsystem* TeamSubsystem = UWorld::GetSubsystem<UDAG_TeamSubsystem>(GetWorld()))
	{
...
void UDAG_TeamCheats::SetTeam(int32 TeamID)
{
	if (UDAG_TeamSubsystem* TeamSubsystem = UWorld::GetSubsystem<UDAG_TeamSubsystem>(GetWorld()))
	{
...
void UDAG_TeamCheats::ListTeams()
{
	if (UDAG_TeamSubsystem* TeamSubsystem = UWorld::GetSubsystem<UDAG_TeamSubsystem>(GetWorld()))
	{
		const TArray<int32> TeamIDs = TeamSubsystem->GetTeamIDs();
