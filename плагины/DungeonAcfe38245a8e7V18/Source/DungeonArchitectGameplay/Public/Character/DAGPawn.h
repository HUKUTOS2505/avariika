 ...
 */
UCLASS()
class DUNGEONARCHITECTGAMEPLAY_API ADAG_Pawn : public APawn, public IDAG_TeamAgentInterface
{
	GENERATED_BODY()

public:

	ADAG_Pawn(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
