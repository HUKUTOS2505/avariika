...
// Last Modified: 7th December 2024
//
...
FText rdPopUpAssetPicker::getAssetDetails() const {
	...
	return FText::FromString(getAssetData().IsValid()?getAssetData().GetFullName():TEXT("Nothing Selected"));
}
...
FText rdPopUpAssetPicker::getAssetName() const {
	...
	FText Value=FText::FromString(*defaultEmptyValue);//TEXT("Select FoliageType"));
