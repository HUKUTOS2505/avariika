...
- **Дальше:** навесить импортированное по ТЗ (репоинт FObjectFinder + новые лупы idle/огнетушитель/эмбиент) — в окно сборки. Текущая механика сварки/стартера/последовательность «вентиль→заварить» — в бэклоге.
