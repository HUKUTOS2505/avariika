...
1. **Фиксы по фидбеку пользователя** из PIE-теста модулей (мини-игры, диспетчер, косяки оборудования, касса/репутация, колхоз, ловушки, запах, биоснаряд).
...
4. Ещё асет-фри из концепта при желании: §18 другие ловушки (датчик движения, прожектор, лужа пены, подпорка под дверь); §18 «косяки оборудования» добивки (датчик газа пищит без причины, рация ловит чужой голос — частично есть); грязь/следы (нужны декали).
