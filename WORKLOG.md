...
1. **Фиксы по фидбеку пользователя** из PIE-теста модулей (мини-игры, диспетчер, косяки оборудования, касса/репутация, колхоз, ловушки, запах).
...
4. Ещё асет-фри из концепта при желании: §15 биологический снаряд (метаемый, на базе запаха+ловушки); §18 другие ловушки (датчик движения, прожектор, лужа пены, подпорка под дверь); грязь/следы (нужны декали).
