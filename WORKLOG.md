...
1. **Фиксы по фидбеку пользователя** из PIE-теста модулей (мини-игры, диспетчер, косяки оборудования, касса/репутация).
...
4. Ещё асет-фри из концепта при желании: §15-16 запах/грязь/биоснаряд, §18 предметы-ловушки/«не тот инструмент».
