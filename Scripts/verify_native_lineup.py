# -*- coding: utf-8 -*-
"""Ряд НАТИВНО переимпортированных мешей (из подпапок) по центру y=-134 для проверки многоцветности."""
import unreal
...
for a in list(eas.get_all_level_actors()):
    if a.get_actor_label().startswith('PROD_'):
        eas.destroy_actor(a)
CY = -134.0
items = [('SM_FireExtinguisher', -150.0), ('SM_FirstAidKit', -50.0), ('SM_Radio', 40.0), ('SM_WeldingMachine', 130.0)]
out = []
