...
Параллельный аудит (2026-06-14): отдельные агенты прочитали структуру/зависимости каждого пака и оценили применимость к Аварийке. Каталог самих паков — см. [ASSETS.md](ASSETS.md).
